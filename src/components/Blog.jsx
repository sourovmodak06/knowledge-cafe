        ...
        <div className='my-8 md:w-[845px]'>
            ...
            <div className='flex justify-between items-center mt-5'>
                ...
                <div className='flex justify-between items-center'>
                    <h3 className='text-xl font-medium text-[#11111199] mr-1 md:mr-2'>{readTime} min read</h3>
                    <button  onClick={() => bookmarkedBlogs(props.blog)}>
                        <FontAwesomeIcon icon={faBookmark}/>
                    </button>
                </div>
            </div>
            <h3 className='text-2xl md:text-3xl font-bold my-4'>{blogTitle}</h3>
            <h4 className='text-xl font-medium text-[#11111199] mr-2'>#beginners  #programming</h4>
            <button className='underline text-[#6047EC] text-xl font-semibold my-4 md:my-7' onClick={() => readsTime(props.blog)}>Mark as read</button>
